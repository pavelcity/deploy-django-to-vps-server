...
!!! note "пояснения"
    === "Шаги"
        1. Здесь рассматривается запуск проекта разработанного на django со стандартной базой данных sqlite3.
    ...
    === "ssl"
        1. Нуачимся подключать к нашему домену ssl сертификат
